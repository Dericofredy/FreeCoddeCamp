...
Crie uma função chamada functionWithArgs que aceita dois argumentos e exibe a soma de seus valores no console de desenvolvimento.
Chame a função com dois números como argumentos.
  */
/* DEFININDO A FUNÇÃO E SEUS PARAMETROS */
function functionWithArgs (param1,param2){
console.log(param1+param2);
} 
/* INSERINDO OS ARGUMENTOS AO CHAMAR A FUNÇÃO */
